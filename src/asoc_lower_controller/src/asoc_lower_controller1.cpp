...
float linkTheta; // the angle between four-parallel link and horizontal ground, variable, so need to be passed by Encoder
float D = 0.178  + 0.14 * sin(linkTheta); //length of the virtual rod linking the pivot rod and the center of ASOC
